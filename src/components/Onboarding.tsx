...
export function Onboarding({
  ...
  const themeStep = <Box marginX={1}>
      <ThemePicker onThemeSelect={handleThemeSelection} showIntroText={true} helpText="之后可通过 /theme 命令修改" hideEscToCancel={true} skipExitHandling={true} // Skip exit handling as Onboarding already handles it
    />
    </Box>;
        ...
        <OrderedList>
          <OrderedList.Item>
            ...
            <Text dimColor wrap="wrap">
              请务必审查 Claude 的回复，尤其是在执行代码时。
              <Newline />
            </Text>
          </OrderedList.Item>
          <OrderedList.Item>
            <Text>
              由于存在提示注入风险，请仅在可信代码上使用
            </Text>
            <Text dimColor wrap="wrap">
              详情请参阅：
              <Newline />
    ...
    steps.push({
      ...
      component: <Box flexDirection="column" gap={1} paddingLeft={1}>
          ...
          <Box flexDirection="column" width={70} gap={1}>
            ...
            <Text dimColor>
              {exitState.pending ? <>再按 {exitState.keyName} 退出</> : <>Enter 确认 · Esc 跳过</>}
            </Text>
          </Box>
        </Box>
    });
  ...
  return <Box flexDirection="column">
      ...
      <Box flexDirection="column" marginTop={1}>
        ...
        {exitState.pending && <Box padding={1}>
            <Text dimColor>再按 {exitState.keyName} 退出</Text>
          </Box>}
      </Box>
    </Box>;
}
